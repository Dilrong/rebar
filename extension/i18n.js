export const messages = {
    en: {
        "ext.title": "REBAR Clipper",
        "ext.hint": "Collect selected highlight or article text, then save directly to REBAR.",
        "ext.loginReq": "Login required to save clips.",
        "ext.loginBtn": "Sign In to REBAR",
        "ext.clipBtn": "Clip Highlight",
        "ext.articleBtn": "Clip Article",
        "ext.domainTags": "Domain tags",
        "ext.previewTitle": "Clip Preview",
        "ext.status.previewBtn": "Review clip before saving",
        "ext.status.collecting": "Collecting content...",
        ...
        "ext.previewLoaded": "Preview loaded. Edit if needed, then save to REBAR.",
        "ext.noClipPreview": "No clip preview available",
        "ext.contentReq": "Content is required",
        "ext.savedSuccess": "Saved to REBAR",
        "ext.domainTagsEnabled": "Domain tags enabled",
        "ext.domainTagsDisabled": "Domain tags disabled",
        "ext.domainTagsFail": "Could not toggle domain tags",
        "ext.previewCanceled": "Preview canceled",
        ...
        "ext.opt.domainTags": "Always suggest domain-based tags",
    ...
    ko: {
        "ext.title": "REBAR 클리퍼",
        "ext.hint": "선택한 하이라이트나 아티클 내용을 REBAR에 바로 저장하세요.",
        "ext.loginReq": "클립을 저장하려면 로그인이 필요합니다.",
        "ext.loginBtn": "REBAR 로그인",
        "ext.clipBtn": "하이라이트 스크랩",
        "ext.articleBtn": "아티클 스크랩",
        "ext.domainTags": "도메인 태그",
        "ext.previewTitle": "클립 미리보기",
        "ext.status.previewBtn": "저장 전 클립 검토",
        "ext.status.collecting": "내용 추출 중...",
        ...
        "ext.previewLoaded": "미리보기를 불러왔습니다. 필요한 경우 수정 후 REBAR에 저장하세요.",
        "ext.noClipPreview": "클립 미리보기가 없습니다.",
        "ext.contentReq": "내용은 필수입니다.",
        "ext.savedSuccess": "REBAR에 저장되었습니다.",
        "ext.domainTagsEnabled": "도메인 태그 켜짐",
        "ext.domainTagsDisabled": "도메인 태그 꺼짐",
        "ext.domainTagsFail": "도메인 태그를 변경할 수 없습니다.",
        "ext.previewCanceled": "미리보기 취소됨",
        ...
        "ext.opt.domainTags": "도메인 기반 추천 태그 항상 추가하기",
        "ext.opt.save": "설정 저장하기",
        "ext.opt.saved": "설정이 저장되었습니다.",
        "ui.error": "알 수 없는 오류 발생",
        "record.title": "제목",
        "record.url": "URL 주소",
        "record.tags": "태그 (쉼표로 구분)",
        "record.content": "내용",
        "ext.saveToRebar": "REBAR에 저장",
        "ui.cancel": "취소",
        "ext.status.ready": "준비 완료",
        "ext.openSettings": "설정 열기",
        "ext.status.checking": "로그인 확인 중...",
        "ext.status.connError": "연결 실패. 설정을 확인해주세요.",
