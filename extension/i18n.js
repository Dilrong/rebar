const messages = {
  en: {
    ...
    "ext.originBlocked": "Extension origin blocked by server. Set REBAR_ALLOW_ALL_EXTENSION_ORIGINS=true in your environment.",
  ...
  ko: {
    ...
    "ext.originBlocked": "익스텐션 origin이 서버에서 차단되었습니다. 환경변수 REBAR_ALLOW_ALL_EXTENSION_ORIGINS=true를 설정해주세요.",
