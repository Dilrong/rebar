  ...
  return (
    <section className="mt-8 border-4 border-foreground bg-card shadow-brutal hover:shadow-brutal-sm transition-shadow duration-300">
      <details open className="group">
        <summary className="flex cursor-pointer items-center justify-between border-b-4 border-foreground p-4 md:p-6 font-black text-xl uppercase select-none list-none transition-colors hover:bg-foreground/5">
          ...
          <span className="font-mono text-xs text-muted-foreground group-open:hidden uppercase tracking-widest bg-foreground text-background px-2 py-1">▼ SHOW</span>
          <span className="font-mono text-xs text-muted-foreground hidden group-open:inline uppercase tracking-widest border-2 border-foreground px-2 py-1">▲ HIDE</span>
        </summary>
